...
public class SwaggerConfig {
	...
	private Predicate<String> postPaths() {
		return or(regex("/customers/.*"), regex("/products/.*"), regex("/cart/.*"), regex("/Admin/.*"), regex("/Land/.*"), regex("/schedulers/.*"), regex("/contracts/.*"), regex("/orders/.*"),regex("/registration/.*"),regex("/register-admin/.*"));
	}
